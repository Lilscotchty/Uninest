        ...
        {step === 1 && (
          <div className="bg-card-bg p-4 rounded-2xl shadow-sm border-transparent border flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} className="w-full border border-border-subtle rounded-xl px-4 py-2.5 text-sm bg-app-bg focus:border-indigo outline-none h-24 resize-none" placeholder="Describe the atmosphere, community..." />
            </div>
            ...
            {formData.nearestCampus && (
              <div className="flex items-start gap-3 bg-indigo/5 border border-indigo/20 rounded-xl px-4 py-3 animate-in fade-in">
                ...
                <div className="flex flex-col gap-0.5 min-w-0">
                  ...
                  <span className="text-sm font-semibold text-text-primary truncate">{formData.nearestCampus.name}</span>
              ...
              <div key={room.id} className="border border-border-subtle rounded-xl p-4 bg-app-bg/50 relative">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input type="text" value={room.name} onChange={(e) => { const nr = [...formData.roomTypes!]; nr[index].name = e.target.value; setFormData({ ...formData, roomTypes: nr }); }} placeholder="e.g. 2 in a room" className="w-full border border-border-subtle rounded-lg px-3 py-2 text-sm bg-white" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-text-primary">Total Rooms</label>
                    <input type="number" value={room.totalRooms || ""} onChange={(e) => { const nr = [...formData.roomTypes!]; nr[index].totalRooms = Number(e.target.value); setFormData({ ...formData, roomTypes: nr }); }} placeholder="10" className="w-full border border-border-subtle rounded-lg px-3 py-2 text-sm bg-white" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-text-primary">Occupants per rm.</label>
                    <input type="number" value={room.occupantsPerRoom || ""} onChange={(e) => { const nr = [...formData.roomTypes!]; nr[index].occupantsPerRoom = Number(e.target.value); setFormData({ ...formData, roomTypes: nr }); }} placeholder="2" className="w-full border border-border-subtle rounded-lg px-3 py-2 text-sm bg-white" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-text-primary">Price (per Sem)</label>
                    <input type="number" value={room.pricePerYear || ""} onChange={(e) => { const nr = [...formData.roomTypes!]; nr[index].pricePerYear = Number(e.target.value); setFormData({ ...formData, roomTypes: nr }); }} placeholder="4500" className="w-full border border-border-subtle rounded-lg px-3 py-2 text-sm bg-white" />
                  </div>
                  <div className="flex flex-col gap-1.5">
        ...
        {step === 4 && (
          <div className="bg-card-bg p-4 rounded-2xl shadow-sm border-transparent border flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea value={formData.policies} onChange={(e) => setFormData({ ...formData, policies: e.target.value })} className="w-full border border-border-subtle rounded-xl px-4 py-2.5 text-sm bg-app-bg focus:border-indigo outline-none h-24 resize-none" placeholder="Guest policies, curfew timings..." />
            </div>
          </div>
        )}
