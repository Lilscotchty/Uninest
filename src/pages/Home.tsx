            ...
            {FILTERS.map((f) => (
              <button
                ...
                className={`flex flex-row items-center gap-1.5 shrink-0 px-4 py-2.5 rounded-full text-[0.85rem] font-medium transition-all border ${
                  activeFilter === f.id 
                    ? 'bg-[var(--color-accent)] text-white border-[var(--color-accent)] shadow-[0_4px_12px_var(--color-accent-muted)]' 
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                  ...
                  <div key={i} className="min-w-full sm:min-w-[400px] snap-center bg-card-bg border border-border-subtle rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="p-5">
                      ...
                      <button 
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-[var(--color-surface-hover)] text-text-primary border border-border-subtle rounded-xl px-4 py-2.5 text-sm font-bold cursor-pointer transition-all hover:bg-[var(--color-accent)] hover:text-white hover:border-[var(--color-accent)] active:scale-[0.98]"
                      >
              ...
              <div className="flex justify-center gap-1.5 mt-1 mb-2">
                {featuredProperties.map((_, i) => (
                  <div key={i} className={`h-1.5 rounded-full transition-all duration-300 ${i === currentFeatured ? 'w-6 bg-[var(--color-accent)]' : 'w-1.5 bg-border-subtle'}`} />
                ))}
              </div>
            </div>
          </div>
