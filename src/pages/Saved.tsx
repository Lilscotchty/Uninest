            ...
            <div key={h.id} className="flex flex-col relative origin-center transition-all animate-in fade-in slide-in-from-bottom-4 duration-500 group">
              <div className="w-full h-[220px] rounded-[20px] overflow-hidden relative shadow-card bg-slate-200">
                ...
                <button 
                  ...
                  className="absolute top-3.5 right-3.5 bg-card-bg/85 backdrop-blur-md text-[var(--color-accent)] w-9 h-9 rounded-full flex items-center justify-center border-none cursor-pointer transition-all hover:bg-[var(--color-button)] hover:text-white shadow-[0_4px_12px_rgba(0,0,0,0.1)] z-10 group-active:scale-110"
                >
                  <Bookmark size={18} fill="currentColor" />
                </button>
                
                <div className="absolute bottom-3.5 left-3.5 bg-[var(--color-button)]/85 backdrop-blur-md text-white px-3.5 py-2 rounded-2xl text-[1.25rem] font-bold flex flex-col leading-none shadow-sm z-10">
                  {h.price}
