...
export const Details: React.FC = () => {
  ...
  // FIX: The string is now properly closed with a backtick and semicolon
        ...
        <div className="bg-app-bg -mt-8 relative z-[5] rounded-t-[32px] pt-6 px-6 shadow-[0_-10px_20px_rgba(0,0,0,0.05)] pb-10">
          ...
          <div className="flex gap-2.5 mb-4 px-1 pb-1 overflow-x-auto hide-scrollbar">
            <button
              ...
              className={`px-[18px] py-[8px] rounded-full text-[0.85rem] font-bold transition-all shrink-0 ${activeRoomMode === "single" ? "bg-[var(--color-accent)]-dark text-white shadow-sm" : "bg-slate-200 text-text-primary"}`}
            >
              Single
            </button>
            <button
              onClick={() => setActiveRoomMode("double")}
              className={`px-[18px] py-[8px] rounded-full text-[0.85rem] font-bold transition-all shrink-0 ${activeRoomMode === "double" ? "bg-[var(--color-accent)]-dark text-white shadow-sm" : "bg-slate-200 text-text-primary"}`}
            >
              Double
            </button>
            <button
              onClick={() => setActiveRoomMode("quad")}
              className={`px-[18px] py-[8px] rounded-full text-[0.85rem] font-bold transition-all shrink-0 ${activeRoomMode === "quad" ? "bg-[var(--color-accent)]-dark text-white shadow-sm" : "bg-slate-200 text-text-primary"}`}
            >
              Quad
            </button>
          </div>
            ...
            <div className="p-[18px]">
              ...
              <div className="flex gap-3 flex-wrap mb-3.5">
                <div className="text-[0.8rem] text-text-muted font-medium flex items-center gap-1.5">
                  <Ruler size={14} className="text  html: `<div style="background:#178053;width:14px;height:14px;border-radius:50%;border:3px solid white;box-shadow:0 2px 8px rgba(23,128,83,0.4);"></div>`,
  iconSize: [14, 14],
  iconAnchor: [7, 7],
});
