...
const customMarkerIcon = new L.DivIcon({
  html: `<div style="width: 20px; height: 20px; background-color: #178053; border-radius: 50%; border: 3px solid white; box-shadow: 0 0 10px rgba(0,0,0,0.3);"></div>`,
  className: '',
  iconSize: [20, 20],
  iconAnchor: [10, 10],
});
    ...
    <div className="flex flex-col gap-2">
      <div className="flex gap-2">
         ...
         <button
            ...
            className="bg-slate-800 text-slate-900 font-bold whitespace-nowrap px-4 rounded-xl hover:bg-[#c7d2fe] transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-1.5"
         >
           {status === 'VERIFYING' ? (
