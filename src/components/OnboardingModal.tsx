            ...
            return (
              ...
              >
                <div className={`w-12 h-12 rounded-[14px] flex items-center justify-center flex-shrink-0 transition-colors ${
                  selected ? 'bg-[var(--color-accent)]/10 text-[var(--color-accent)]' : 'bg-slate-100/5 text-text-muted border border-[var(--color-border)]'
                }`}>
                  {roleIcons[role]}
                </div>
                ...
                <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 transition-all ${
                  selected ? 'bg-[var(--color-accent)] scale-100' : 'border-2 border-[var(--color-border)] scale-90 opacity-40'
                }`}>
        ...
        <button
          ...
          className={`w-full h-[54px] rounded-xl font-bold text-[0.95rem] tracking-wide text-white flex items-center justify-center gap-2 transition-all duration-200 ${
            !selectedRole || saving 
              ...
              : 'bg-[var(--color-accent)] hover:opacity-90 active:scale-[0.98] shadow-[0_4px_20px_rgba(192,132,60,0.25)]'
          }`}
        >
          {saving ? (
